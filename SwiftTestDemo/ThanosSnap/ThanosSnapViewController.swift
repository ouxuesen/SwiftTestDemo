//
//  ThanosSnapViewController.swift
//  SwiftTestDemo
//
...
class ThanosSnapViewController: UIViewController {
    var playing = false
    ...
    override func viewDidLoad() {
        ...
        gauntlet.frame = CGRect.init(x: 0, y: 0, width: UIScreen.main.bounds.size.width, height: 80)
        ...
        tableView.tableFooterView = gauntlet
        ...
        NSLayoutConstraint.activate([
            ...
            //            gauntlet.widthAnchor.constraint(equalTo: tableView.widthAnchor),
            //            gauntlet.heightAnchor.constraint(equalToConstant: 80),
            ])
    }
...
extension ThanosSnapViewController: UITableViewDataSource {
...
extension ThanosSnapViewController: ThanosGauntletDelegate {
...
extension ThanosSnapViewController: DustEffectViewDelegate {
